...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Divyansh Kumar Chaturvedi',", type: 'array-item' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Divyansh <span className={styles.accentText}>Chaturvedi</span>
          </h1>
          ...
          <div className={styles.actionLinks} style={{ display: 'flex', gap: '1rem' }}>
            <Link href="/projects" className={styles.primaryLink}>
              View Projects <VscArrowRight />
            </Link>
            <a
              href="https://1drv.ms/b/c/f07e5a798e370f07/EQlZYsrY655CvbhYQ1M8LPkBzdojLEV9MDbLbDWOlzWumw?e=fkZdIY"
              target="_blank"
